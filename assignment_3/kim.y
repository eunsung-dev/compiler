%token IDENTIFIER AUTO_SYM BREAK_SYM CASE_SYM CONTINUE_SYM
    ...
    WHILE_SYM TYPE_IDENTIFIER PLUSPLUS MINUSMINUS ARROW LSS GTR LEQ GEQ
    EQL NEQ AMPAMP BARBAR DOTDOTDOT LP RP LB RB LR RR COLON PERIOD
    COMMA EXCL STAR SLASH PERCENT AMP SEMICOLON PLUS MINUS ASSIGN
...
iteration_statement
    ...
    | DO_SYM statement WHILE_SYM LP expression RP
